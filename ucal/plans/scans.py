...
_default_regions = {"Zn": [1010, 1015, 0.5, 1030, 0.125, 1040, 0.2, 1060,
                           0.25, 1070, 0.5],
...
for e, region in _default_regions.items():
    name = f"{e.lower()}_xas"
    globals()[name] = xas_factory(e, region, name)
